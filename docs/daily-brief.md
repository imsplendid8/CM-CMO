...
- **주목할 뉴스**는 공통 브리프(`data/briefing/latest.json`)의 상위 3건 — `무슨 일 / 왜 중요 / 오늘 대응`과 근거 링크를 대시보드·이메일과 동일하게 표시
...
· [경쟁사·현대해상] 페달 오조작 안전장치 보험료 할인 특약
  무슨 일 · 안전장치 장착 차량의 할인 대상이 확대됐습니다.
  왜 중요 · 가격·안전 소구의 경쟁 기준이 달라질 수 있습니다.
  오늘 대응 · 경쟁사 할인 조건과 자사 안전 소구를 비교하세요. · 원문
