...
- `scripts/seo_title_agent.py`: SearchAd·FAQ·비공개 GSC를 결합한 제목 검토 큐
- `data/seo/title-opportunities.json`: 공개 가능한 범주형 산출물
- `seo-audit.html`: 후보 3개, 근거, 약점, GSC 상태, 추천 차단 상태 표시
