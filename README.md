...
| 콘텐츠·심의 | `adcopy-tool.html`, `powercontent-tool.html` | SA 심의안 초안과 파워콘텐츠 포스팅·광고 소재의 분리 제작 |

SA 소재 도구는 실제 심의안 순서로 문구를 제안하고 같은 구조의 Excel 심의안 초안을 생성합니다. 파워콘텐츠 도구는 블로그 포스팅 제목과 공식 등록 필드인 제목·원문 발췌 설명·URL·이미지·업체명·발행일을 분리해 준비합니다. 두 결과물 모두 최신 상품자료·약관·준법·광고심의를 거쳐야 합니다.
